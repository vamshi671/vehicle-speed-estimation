...
This project implements real-time vehicle speed estimation from traffic videos using YOLOv8 and computer vision.
...
The center point of each bounding box is tracked over frames.
...
Speeds are smoothed and displayed on the video in km/h.
📂 Project Structure
